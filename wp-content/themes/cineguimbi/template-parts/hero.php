...
<?php for($x = 1; $x <= 3 ; $x++):?>
    <div class="w-screen h-hero overflow-hidden relative md:mb-12 after:hidden lg:after:bg-hero-desktop after:bg-contain after:bg-center after:bg-no-repeat lg:after:block after:absolute after:top-0 after:-left-[30%] xxl:after:-left-0 xxl:after:w-1/2 xxl:after:bg-cover after:h-full after:w-full">
