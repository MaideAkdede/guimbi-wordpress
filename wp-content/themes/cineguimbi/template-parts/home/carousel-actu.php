<section class="relative">
    ...
    <div class="max-w-xxl mx-auto grid auto-rows-[minmax(0,350px)] grid-cols-1 lg:grid-cols-2 gap-5 px-5 carousel-actu">
        <?php for ($x = 1; $x <= 4; $x++): ?>
            <article class="text-center font-bold font-family-bold relative aspect-card drop-shadow-md md:aspect-auto md:grid md:grid-cols-md-actu md:text-left overflow-hidden">
                ...
                <div class="bg-white mx-auto -mt-full absolute bottom-0 z-10 w-full py-8 px-6 md:static">
                    ...
                    <a href="" title="" class="max-w-max block mx-auto pt-2 pb-1 px-3 mt-6 uppercase text-xs text-primary transition ease-in-out hover:text-white hover:bg-primary md:mx-0 focus:text-white focus:bg-primary focus:outline-none focus:ring-primary focus:ring-2 focus:ring-offset-2">En savoir plus<span class="sr-only"> sur XXX</span></a>
                </div>
            </article>
        <?php endfor; ?>
    </div>
