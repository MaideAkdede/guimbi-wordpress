<section class="py-12 relative">
    ...
    <div class="max-w-xxl mx-auto grid auto-rows-[minmax(0,350px)] grid-cols-1 lg:grid-cols-2 gap-5 px-5 carousel-actu">
        <?php for ($x = 1; $x <= 4; $x++): ?>
            <article class="text-center font-bold font-family-bold relative aspect-card-long drop-shadow-md md:aspect-auto md:grid md:grid-cols-md-actu md:text-left overflow-hidden">
