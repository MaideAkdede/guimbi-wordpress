<div class="w-screen h-hero overflow-hidden relative md:mb-16 lg:mb-24">
    ...
    <div class="max-w-xxl w-full right-1/2 translate-x-1/2 mx-auto px-5 absolute bottom-hero md:top-0 md:h-full">
        <div class="bg-primary rounded-tr-4xl text-white pt-22px pb-33px px-25px w-3/4 max-w-hero-top md:max-w-md relative md:h-full">
            <div class="bg-hero-texture opacity-6 bg-cover bg-no-repeat absolute h-full w-full z-2 top-0 left-0 rounded-tr-4xl backdrop-grayscale"></div>
